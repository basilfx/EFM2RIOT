...
WEAK_DEFAULT void isr_cryptoacc(void);
WEAK_DEFAULT void isr_trng(void);
WEAK_DEFAULT void isr_pke(void);
...
WEAK_DEFAULT void isr_rdmailbox(void);
...
WEAK_DEFAULT void isr_euart0_rx(void);
WEAK_DEFAULT void isr_euart0_tx(void);

/* interrupt vector table */
ISR_VECTOR(1) const isr_t vector_cpu[CPU_IRQ_NUMOF] = {
    [ 0] = isr_cryptoacc,          /* CRYPTOACC */
    [ 1] = isr_trng,               /* TRNG */
    [ 2] = isr_pke,                /* PKE */
    [ 3] = isr_smu_secure,         /* SMU_SECURE */
    [ 4] = isr_smu_privileged,     /* SMU_PRIVILEGED */
    [ 5] = isr_smu_ns_privileged,  /* SMU_NS_PRIVILEGED */
    [ 6] = isr_emu,                /* EMU */
    [ 7] = isr_timer0,             /* TIMER0 */
    [ 8] = isr_timer1,             /* TIMER1 */
    [ 9] = isr_timer2,             /* TIMER2 */
    [10] = isr_timer3,             /* TIMER3 */
    [11] = isr_timer4,             /* TIMER4 */
    [12] = isr_rtcc,               /* RTCC */
    [13] = isr_usart0_rx,          /* USART0_RX */
    [14] = isr_usart0_tx,          /* USART0_TX */
    ...
    [39] = isr_rdmailbox,          /* RDMAILBOX */
    [40] = isr_rfsense,            /* RFSENSE */
    [41] = isr_prortc,             /* PRORTC */
    [42] = isr_synth,              /* SYNTH */
    [43] = isr_wdog0,              /* WDOG0 */
    [44] = isr_hfxo0,              /* HFXO0 */
    [45] = isr_hfrco0,             /* HFRCO0 */
    [46] = isr_cmu,                /* CMU */
    [47] = isr_aes,                /* AES */
    [48] = isr_iadc,               /* IADC */
    [49] = isr_msc,                /* MSC */
    ...
    [54] = isr_sw2,                /* SW2 */
    [55] = isr_sw3,                /* SW3 */
    [56] = isr_kernel0,            /* KERNEL0 */
    [57] = isr_kernel1,            /* KERNEL1 */
    [58] = isr_m33cti0,            /* M33CTI0 */
    [59] = isr_m33cti1,            /* M33CTI1 */
    [60] = isr_emuefp,             /* EMUEFP */
    [61] = isr_dcdc,               /* DCDC */
    [62] = isr_euart0_rx,          /* EUART0_RX */
    [63] = isr_euart0_tx,          /* EUART0_TX */
};
