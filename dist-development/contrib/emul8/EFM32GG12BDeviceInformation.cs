...
namespace Emul8.Peripherals
{
    ...
    public class EFM32GG12BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32GG12BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x6a;
        ...
        // This structure should resemble the structure of efm32gg12b_devinfo.h.
