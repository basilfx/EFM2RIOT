...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG14PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG14PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x37;
        ...
        // This structure should resemble the structure of efr32bg14p_devinfo.h.
