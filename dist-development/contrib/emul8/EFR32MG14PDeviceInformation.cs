...
namespace Emul8.Peripherals
{
    ...
    public class EFR32MG14PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32MG14PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x34;
