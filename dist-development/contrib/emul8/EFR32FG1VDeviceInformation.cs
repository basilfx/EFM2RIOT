...
namespace Emul8.Peripherals
{
    ...
    public class EFR32FG1VDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32FG1VDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x1b;
        ...
        // This structure should resemble the structure of efr32fg1v_devinfo.h.
