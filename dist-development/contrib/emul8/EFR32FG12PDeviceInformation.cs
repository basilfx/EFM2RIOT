...
namespace Emul8.Peripherals
{
    ...
    public class EFR32FG12PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32FG12PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x25;
        ...
        // This structure should resemble the structure of efr32fg12p_devinfo.h.
