...
namespace Emul8.Peripherals
{
    ...
    public class EFM32JG1BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32JG1BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x53;
        ...
        // This structure should resemble the structure of efm32jg1b_devinfo.h.
