...
namespace Emul8.Peripherals
{
    ...
    public class EFM32TG11BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32TG11BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x67;
        ...
        // This structure should resemble the structure of efm32tg11b_devinfo.h.
