...
namespace Emul8.Peripherals
{
    ...
    public class EFM32GGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32GGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x48;
        ...
        // This structure should resemble the structure of efm32gg_devinfo.h.
