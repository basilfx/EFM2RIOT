...
namespace Emul8.Peripherals
{
    ...
    public class EFM32TGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32TGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x49;
        ...
        // This structure should resemble the structure of efm32tg_devinfo.h.
