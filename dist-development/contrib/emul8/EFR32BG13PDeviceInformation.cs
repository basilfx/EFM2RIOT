...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG13PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG13PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x2b;
        ...
        // This structure should resemble the structure of efr32bg13p_devinfo.h.
