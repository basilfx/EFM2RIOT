...
namespace Emul8.Peripherals
{
    ...
    public class EFM32GDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32GDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
        ...
        // This structure should resemble the structure of efm32g_devinfo.h.
