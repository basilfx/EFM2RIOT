...
namespace Emul8.Peripherals
{
    ...
    public class EFR32MG12PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32MG12PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x1c;
        ...
        // This structure should resemble the structure of efr32mg12p_devinfo.h.
