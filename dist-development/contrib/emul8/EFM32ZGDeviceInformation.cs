...
namespace Emul8.Peripherals
{
    ...
    public class EFM32ZGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32ZGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x4c;
        ...
        // This structure should resemble the structure of efm32zg_devinfo.h.
