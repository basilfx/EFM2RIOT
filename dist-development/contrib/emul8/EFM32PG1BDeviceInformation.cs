...
namespace Emul8.Peripherals
{
    ...
    public class EFM32PG1BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32PG1BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x51;
        ...
        // This structure should resemble the structure of efm32pg1b_devinfo.h.
