...
namespace Emul8.Peripherals
{
    ...
    public class EFR32MG1BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32MG1BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x11;
        ...
        // This structure should resemble the structure of efr32mg1b_devinfo.h.
