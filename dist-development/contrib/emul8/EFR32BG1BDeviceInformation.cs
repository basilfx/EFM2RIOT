...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG1BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG1BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x14;
        ...
        // This structure should resemble the structure of efr32bg1b_devinfo.h.
