...
namespace Emul8.Peripherals
{
    ...
    public class EFM32WGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32WGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x4b;
        ...
        // This structure should resemble the structure of efm32wg_devinfo.h.
