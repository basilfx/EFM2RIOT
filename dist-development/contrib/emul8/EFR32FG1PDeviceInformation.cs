...
namespace Emul8.Peripherals
{
    ...
    public class EFR32FG1PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32FG1PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x19;
