...
namespace Emul8.Peripherals
{
    ...
    public class EFR32MG22DeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32MG22DeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
        ...
        // This structure should resemble the structure of efr32mg22_devinfo.h.
