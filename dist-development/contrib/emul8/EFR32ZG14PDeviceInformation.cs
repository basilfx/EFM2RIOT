...
namespace Emul8.Peripherals
{
    ...
    public class EFR32ZG14PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32ZG14PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x3a;
        ...
        // This structure should resemble the structure of efr32zg14p_devinfo.h.
