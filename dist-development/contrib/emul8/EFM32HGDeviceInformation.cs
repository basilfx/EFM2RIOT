...
namespace Emul8.Peripherals
{
    ...
    public class EFM32HGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32HGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x4d;
        ...
        // This structure should resemble the structure of efm32hg_devinfo.h.
        private enum DeviceInformationOffset : long
        {
            ...
            IDAC0CAL0        = 0x014, // IDAC0 calibration register
            USHFRCOCAL0      = 0x018, // USHFRCO calibration register
