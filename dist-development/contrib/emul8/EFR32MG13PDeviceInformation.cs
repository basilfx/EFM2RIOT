...
namespace Emul8.Peripherals
{
    ...
    public class EFR32MG13PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32MG13PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x28;
        ...
        // This structure should resemble the structure of efr32mg13p_devinfo.h.
