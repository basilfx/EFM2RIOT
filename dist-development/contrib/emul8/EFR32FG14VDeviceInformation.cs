...
namespace Emul8.Peripherals
{
    ...
    public class EFR32FG14VDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32FG14VDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x3f;
        ...
        // This structure should resemble the structure of efr32fg14v_devinfo.h.
