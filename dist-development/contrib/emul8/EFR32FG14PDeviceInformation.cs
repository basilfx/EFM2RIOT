...
namespace Emul8.Peripherals
{
    ...
    public class EFR32FG14PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32FG14PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x3d;
        ...
        // This structure should resemble the structure of efr32fg14p_devinfo.h.
