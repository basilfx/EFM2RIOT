...
namespace Emul8.Peripherals
{
    ...
    public class EFM32JG12BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32JG12BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x57;
        ...
        // This structure should resemble the structure of efm32jg12b_devinfo.h.
