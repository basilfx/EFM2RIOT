...
namespace Emul8.Peripherals
{
    ...
    public class EZR32WGDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EZR32WGDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x78;
        ...
        // This structure should resemble the structure of ezr32wg_devinfo.h.
