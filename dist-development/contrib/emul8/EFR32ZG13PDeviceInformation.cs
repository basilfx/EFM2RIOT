...
namespace Emul8.Peripherals
{
    ...
    public class EFR32ZG13PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32ZG13PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x2e;
        ...
        // This structure should resemble the structure of efr32zg13p_devinfo.h.
