...
namespace Emul8.Peripherals
{
    ...
    public class EFM32PG12BDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFM32PG12BDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x55;
        ...
        // This structure should resemble the structure of efm32pg12b_devinfo.h.
