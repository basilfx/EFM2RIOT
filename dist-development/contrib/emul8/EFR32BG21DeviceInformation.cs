...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG21DeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG21DeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
        ...
        // This structure should resemble the structure of efr32bg21_devinfo.h.
