...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG1PDeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG1PDeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
            this.flashSize = flashSize;
            this.sramSize = sramSize;
            this.productRevision = productRevision;
            this.deviceFamily = 0x13;
        ...
        // This structure should resemble the structure of efr32bg1p_devinfo.h.
