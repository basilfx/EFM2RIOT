...
namespace Emul8.Peripherals
{
    ...
    public class EFR32BG22DeviceInformation: IDoubleWordPeripheral, IKnownSize
    {
        public EFR32BG22DeviceInformation(ushort deviceNumber, ushort flashSize, ushort sramSize, byte productRevision = 0)
        {
        ...
        // This structure should resemble the structure of efr32bg22_devinfo.h.
