...
## Hardware
![SLSTK3701A Starter Kit](images/slstk3701a.png)
...
For using the Silicon Labs SLSTK3701A starter kit we strongly recommend the usage of the [GNU Tools for ARM Embedded Processors](https://developer.arm.com/open-source/gnu-toolchain/gnu-rm) toolchain.
